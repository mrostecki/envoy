REPOSITORY_LOCATIONS = dict(
    ...
    com_github_c_ares_c_ares = dict(
        sha256 = "327ca0ac334f8bcdc8d9da0cbc5e0ff2e304c248aab6cac8835936b1e3548a86",
        strip_prefix = "c-ares-1.15.0-20191108",
        # 2019-06-19
        ...
        urls = ["https://c-ares.haxx.se/daily-snapshot/c-ares-1.15.0-20191108.tar.gz"],
    ),

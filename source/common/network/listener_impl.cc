...
void ListenerImpl::listenCallback(evconnlistener*, evutil_socket_t fd, sockaddr* remote_addr,
  ...
  Address::InstanceConstSharedPtr local_address = Address::addressFromFd(fd);
  Address::InstanceConstSharedPtr final_local_address = local_address;
...
void ListenerImpl::newConnection(int fd, Address::InstanceConstSharedPtr remote_address,
  ...
  new_connection->setUsingOriginalDst(using_original_dst);
